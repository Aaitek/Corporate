...
export interface ApiArticleArticle extends Schema.CollectionType {
  ...
  attributes: {
    ...
    category: Attribute.Enumeration<['tech', 'press', 'tutorial', 'news']>;
...
export interface ApiCaseStudyCaseStudy extends Schema.CollectionType {
  ...
  info: {
    description: 'Partner success case studies';
  ...
  attributes: {
    category: Attribute.Enumeration<
      ['cloud', 'ai', 'ecommerce', 'mobile', 'data', 'software']
    > &
      Attribute.Required;
...
export interface ApiManagedServiceManagedService extends Schema.CollectionType {
  collectionName: 'managed_services';
  info: {
    description: 'Managed services offered by Aaitek';
    displayName: 'Managed Service';
    pluralName: 'managed-services';
    singularName: 'managed-service';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::managed-service.managed-service',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
    ...
    publishedAt: Attribute.DateTime;
    slug: Attribute.UID<'api::managed-service.managed-service', 'title'>;
    title: Attribute.String & Attribute.Required;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'api::managed-service.managed-service',
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  info: {
    description: 'Products offered by Aaitek';
    displayName: 'Product';
    pluralName: 'products';
...
export interface ApiServiceService extends Schema.CollectionType {
  ...
  info: {
    description: 'Services offered by Aaitek';
    displayName: 'Service';
    pluralName: 'services';
