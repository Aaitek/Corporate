      ...
      columns: [
        {
          ...
          icon: '👥',
          items: [
            { label: 'Staff Augmentation', path: '/hire-talent/staff-augmentation' },
            { label: 'Dedicated Teams', path: '/hire-talent/dedicated-teams' },
            { label: 'On-Demand Support', path: '/hire-talent/on-demand-support' },
          ],
        },
        {
          title: 'Expertise',
          icon: '💻',
          items: [
            { label: 'Frontend & Full-Stack Engineering', path: '/hire-talent/frontend-fullstack-engineering' },
            { label: 'Backend & API Engineering', path: '/hire-talent/backend-api-engineering' },
            { label: 'Cloud & DevOps', path: '/hire-talent/cloud-devops' },
            { label: 'Data & AI', path: '/hire-talent/data-ai' },
            { label: 'Enterprise Platforms', path: '/hire-talent/enterprise-platforms' },
          ],
        },
      ],
    },
        ...
        <div className="flex items-center justify-between h-16 sm:h-18 md:h-20 relative w-full">
          {/* Logo */}
            <motion.div
              ...
              className="flex-shrink-0 z-10 relative mt-2.5 md:mt-0 lg:-ml-3 xl:-ml-4"
            >
