        ...
        <div className="container-custom relative z-10">
          ...
          >
            ...
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-white/90 max-w-3xl mx-auto">
              Aaitek is an Australia-owned technology and digital transformation company helping organisations design, build, and scale modern digital platforms. We operate at the intersection of engineering excellence, enterprise platforms, and AI-first thinking.
            </p>
          </motion.div>
        </div>
      </section>
