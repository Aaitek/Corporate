              ...
              <div className="relative bg-white rounded-2xl px-3 py-2.5 shadow-md border-2 border-gray-200 group-hover:border-blue-400 group-hover:shadow-lg transition-all duration-300 focus-within:border-blue-500 focus-within:ring-2 focus-within:ring-blue-500/20">
                <div className="flex items-center gap-2.5">
                  ...
                  <select
                    ...
                    className="flex-1 appearance-none bg-transparent border-0 text-gray-700 font-semibold text-xs md:text-sm focus:outline-none cursor-pointer pr-6 group-hover:text-blue-600 transition-colors duration-300"
                  >
                  ...
                  <motion.svg 
                    className="w-4 h-4 text-gray-400 group-hover:text-blue-500 pointer-events-none transition-colors duration-300" 
                    fill="none" 
                    stroke="currentColor" 
                    viewBox="0 0 24 24"
                    animate={{ rotate: 0 }}
